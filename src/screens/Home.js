...
class Home extends Component {
  ...
  componentDidMount() {
    this.props.navigation.addListener("focus", () => {
      AsyncStorage.getItem("location")
        ...
        .catch((err) => {              console.log("Location",location)
    });
    ...
    AsyncStorage.getItem("location")
      ...
      .catch((err) =>       console.log('shjkhkjhjkh',err)
      );
  ...
  LoadResturants() {
    ...
    setTimeout(() => {
      return fetch(
        config.APP_URL + "/api/get_resturents/" + city_id + "?page=" + page_no,
        {
          method: "GET",
          headers: {
            Accept: "application/json",
      ...
      <TouchableOpacity
        ...
        onPress={() =>
          this.props.navigation.navigate("Details", {
            id: item.offerables.restaurants.id,
          })
        }
      >
        <View style={styles.renderItemContent}>
          <Image
            ...
            source={{ uri: item.offerables.restaurants.preview.content }}
          />
            ...
            <View style={styles.flex}>
              ...
              >
                <View style={styles.hconatiner}>
                  <View>
                    <FlatText
                      text="Available Offer Right Now"
                      size={20}
                      color="#333"
                      font="q_regular"
                    />
                  ...
                  <View>
                    <View style={styles.row}>
                      ...
                      <TouchableOpacity
                        onPress={() =>
                          this.setState({ selectCatg: 0, isLoading: false })
                        }
        ...
        >
          <View>
            <Image
              ...
              source={{ uri: param.restaurant_info.preview.content }}
            />
            <View style={styles.badge}>
              <FlatText
                text={param.restaurant_info.delivery.content}
                color="#333"
                font="q_semibold"
                textalign="center"
              />
            ...
            <View>
              <View style={styles.productTitle}>
                <FlatText
                  text={param.restaurant_info.name}
                  size={16}
                  font="q_semibold"
                  color="#333"
                />
                <View>
                  <View style={styles.productContentFlex}>
                    ...
                    />
                    <FlatText
                      text={param.restaurant_info.avg_ratting.content}
                      size={15}
                      font="q_semibold"
                    />
                    <FlatText
